...
RSpec.describe Aletheia::Safety do
  ...
  describe '.verify!' do
    ...
    it 'falla si trading_enabled se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
      end.to raise_error(Aletheia::Safety::ConfigurationError,
                         /'mode\.trading_enabled' DEBE ser false/)
    end
    ...
    it 'falla si futures se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
                         ...
                         /'allowed_markets\.futures' DEBE ser false/)
    end
    ...
    it 'falla si margin se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
                         ...
                         /'allowed_markets\.margin' DEBE ser false/)
    end
    ...
    it 'falla si leverage se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
                         ...
                         /'allowed_markets\.leverage' DEBE ser false/)
    end
    ...
    it 'falla si withdrawals_allowed se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
                         ...
                         /'execution\.withdrawals_allowed' DEBE ser false/)
    end
    ...
    it 'falla si execution.enabled se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock)
                         ...
                         /'execution\.enabled' DEBE ser false/)
    end
    ...
    it 'falla si kill_switch.trading_allowed se pone en true' do
      ...
      expect do
        described_class.verify!(config_mock,
                                risk_mock)
      end.to raise_error(Aletheia::Safety::ConfigurationError, /'kill_switch\.trading_allowed' DEBE ser false/)
    end
    ...
    it 'falla si max_open_positions supera 1' do
      ...
      expect do
        described_class.verify!(config_mock,
                         ...
                         /'risk_limits\.max_open_positions' DEBE ser un entero <= 1/)
    end
  end
end
